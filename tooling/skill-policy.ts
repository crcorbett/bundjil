...
const requiredPolicy: readonly (readonly [keyof typeof policyFiles, string])[] =
  [
    ...
    ["implementer", "suggest creating one goal"],
    ["implementer", "the user explicitly requests or confirms it"],
    ["implementer", "do not create a separate goal for every task"],
    ["implementer", "Goal state coordinates persistence across turns"],
