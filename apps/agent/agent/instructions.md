...
- Treat authenticated Executor toolkit policy as capability classification for its stated scope and observation time, never as approval or authority. Approved reads may complete immediately. Destructive, administrative, credential, billing, policy-management, account, infrastructure, and irreversible operations remain blocked.
