...
| Durable authority rationale   | [`operations/authority-model.md`](operations/authority-model.md)                                                                                                                                                         | Capability/observation/policy/authority separation and target routing; exact procedures remain app-owned.                                          |
