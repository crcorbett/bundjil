...
| Critical journeys and proof       | [`verification/README.md`](verification/README.md)                                                                                                                                                                                                                                                                                                                                                                                                                         | Twelve named journeys, proof packet schemas/templates, bounded receipts, evidence lifecycle, and explicit local/Preview/Production/external limits. |
