...
| Target-owned runbooks         | [`runbooks/README.md`](runbooks/README.md)                                                                                                                                                                               | The Photon provider-only proof is routed; HGI-303 still owns every missing target operation.                            |
...
| Critical journeys and proof   | [`verification/README.md`](verification/README.md)                                                                                                                                                                       | The Photon provider-only receipt is routed; HGI-305 still owns every missing bounded journey.                           |
