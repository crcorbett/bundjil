...
It records the accepted four-token custody slice, the two Production GitHub
secret names, and the explicit Preview Photon stop. Hosted drift and automatic
Production remain open until their required external predicates are proved.
