...
| Reconcile Photon and prove Preview | In progress | The corrected 12.3.0 candidate reached a fresh hosted workflow but failed during Spectrum acquisition with Photon's exact missing-gRPC-peer signature; the Photon package and Eve trace boundary now require explicit runtime peers plus packaged-build proof before another immutable Preview journey |
