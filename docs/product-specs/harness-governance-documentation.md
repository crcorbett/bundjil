...
| HGI-304 — workflow and provider authority                                                                                               | In progress | Hardened workflows, machine authority/action registers, semantic fixtures, bounded source evidence, and fresh-context acceptance     |
