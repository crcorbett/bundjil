...
| Effect architecture              | Change required; delivered          | `docs/architecture/effect-patterns.md` owns accepted Clock/TestClock, state/ref, collection, Layer, absence, lint-scope, and exact-exception policy.                                                                                                       |
...
| Package READMEs                  | Preserve                            | No package purpose, public export, boundary, or command changed; Photon observation time remains internal to the existing receipt contract.                                                                                                                |
...
| Schemas/services/Layers          | Targeted Change required; delivered | Photon candidate inventory now obtains its existing encoded observation time from Effect Clock; decoded types, service identity, errors, wire fields, and live/memory Layer ownership are unchanged.                                                       |
| Tests/fixtures                   | Change required; delivered          | Fixed epochs and TestClock prove deterministic profile and Photon time; direct and installed lint fixtures prove positive, negative and stale-exception behavior.                                                                                          |
