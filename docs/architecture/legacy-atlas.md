...
successor: ./README.md
superseded_reason: mixed durable architecture with dated deployment and provider observations
last_reviewed: 2026-07-20
---

# Historical architecture atlas

This retained atlas records architecture and rollout observations that were
previously presented as a root current document. Use
[`README.md`](./README.md) for current architecture routes. Deployment IDs,
readiness, webhook topology, provider observations, and production statements
below are historical evidence only; external systems remain authoritative for
