...
description: Create, audit, migrate, or validate Bundjil packages using the repository-owned workspace, namespace, source-condition, Effect boundary, export, exception, and verification contract. Use whenever adding or changing a package or package boundary here.
---
